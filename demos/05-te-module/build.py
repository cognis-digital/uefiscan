...
Run from the repo root:  python demos/05-te-module/build.py
"""
import os, sys
...
def build():
    return fw.assemble(fw.firmware_volume(), fw.secureboot_vars(["PK","KEK","db","dbx"]), fw.te_module(), fw.pe_module(signed=True))
