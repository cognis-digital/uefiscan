#!/usr/bin/env sh
# Universal installer for uefiscan. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/uefiscan.git"
echo "Installing uefiscan ..."
